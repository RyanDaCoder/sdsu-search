...
export function SchedulePanel() {
  ...
  return (
    <aside className="w-full lg:w-[420px] shrink-0 border rounded-lg p-3 space-y-3">
      ...
      <div className="space-y-2">
        {items.length === 0 ? (
          <div className="text-sm text-muted-foreground">Add a section to start building your schedule.</div>
        ) : (
          items.map((it) => (
